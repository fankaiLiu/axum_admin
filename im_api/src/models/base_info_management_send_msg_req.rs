...
pub struct BaseInfoManagementSendMsgReq {
...
impl BaseInfoManagementSendMsgReq {
    pub fn new(content_type: i32, operation_id: String, send_id: String, session_type: i32) -> BaseInfoManagementSendMsgReq {
        BaseInfoManagementSendMsgReq {
